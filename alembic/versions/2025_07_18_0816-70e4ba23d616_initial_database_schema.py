...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("status IN ('active', 'inactive')", name='check_category_status'),
    ...
    op.create_table(
        ...
        sa.CheckConstraint("status IN ('active', 'inactive', 'suspended')", name='check_supplier_status')
    )
    ...
    op.create_table(
        ...
        sa.Column('account_status', sa.String(length=20), nullable=False, default='active'),
        sa.Column('customer_tier', sa.String(length=20), nullable=False, default='bronze'),
        sa.Column('lifetime_value', sa.DECIMAL(precision=12, scale=2), nullable=False, default=0.00),
        sa.Column('total_orders', sa.Integer(), nullable=False, default=0),
        ...
        sa.CheckConstraint("account_status IN ('active', 'inactive', 'suspended')", name='check_account_status'),
    ...
    op.create_table(
        ...
        sa.CheckConstraint("status IN ('active', 'inactive', 'discontinued')", name='check_product_status'),
    ...
    op.create_table(
        ...
        sa.Column('order_status', sa.String(length=20), nullable=False, default='pending'),
        sa.Column('subtotal', sa.DECIMAL(precision=12, scale=2), nullable=False, default=0.00),
        sa.Column('tax_amount', sa.DECIMAL(precision=12, scale=2), nullable=False, default=0.00),
        sa.Column('shipping_cost', sa.DECIMAL(precision=12, scale=2), nullable=False, default=0.00),
        sa.Column('discount_amount', sa.DECIMAL(precision=12, scale=2), nullable=False, default=0.00),
        sa.Column('total_amount', sa.DECIMAL(precision=12, scale=2), nullable=False, default=0.00),
        ...
        sa.CheckConstraint("order_status IN ('pending', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled', 'refunded')", name='check_order_status'),
        sa.CheckConstraint("payment_status IN ('pending', 'paid', 'failed', 'refunded', 'cancelled')", name='check_payment_status'),
    ...
    op.create_table(
        ...
        sa.Column('discount_amount', sa.DECIMAL(precision=10, scale=2), nullable=False, default=0.00),
