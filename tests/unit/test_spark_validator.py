...
from src.utils.spark_validator import main, validate_spark_imports
...
def test_main_runs_without_errors():
    ...
    try:
        ...
        raise AssertionError(f"Main function should not throw exceptions: {e}")
...
def test_main_script_execution():
    ...
    with patch("src.utils.spark_validator.main") as mock_main:
        ...
        with patch("sys.exit") as mock_exit:
            ...
            from src.utils.spark_validator import main

            result = main()
            # Since we're mocking main to return 0, just verify the return value
            assert result == 0
