...
def create_demo_app() -> FastAPI:
    ...
    app.add_middleware(PerformanceLoggingMiddleware, slow_request_threshold=500.0)
    app.add_middleware(
        LoggingMiddleware,
    ...
    async def startup_event():
        ...
        logger.info(
            "Starting ECAP Logging Demo Application",
            app_version="1.0.0",
    ...
    async def demo_basic_logging():
        ...
        with CorrelationContext(
            service_name="demo-service", operation_name="basic_logging_demo"
        ) as ctx:
            logger.info(
            ...
            logger.info(
                "Basic logging demo completed", duration_ms=ctx.get_duration_ms()
            )

            return {
                "message": "Basic logging demonstration completed",
                "correlation_id": ctx.correlation_id,
                "examples": ["debug", "info", "warning", "structured_data"],
            }
    ...
    async def demo_error_logging():
        ...
        with CorrelationContext(operation_name="error_demo") as ctx:
            try:
                ...
                logger.exception(
                    "Demonstration exception occurred",
    ...
    async def demo_performance_logging():
        ...
        with CorrelationContext(operation_name="performance_demo") as ctx:
            ...
            for scenario in scenarios:
                ...
                logger.info(
                    f"Operation completed: {scenario['name']}",
    ...
    async def demo_correlation_tracking():
        ...
        with CorrelationContext(operation_name="correlation_demo") as ctx:
            logger.info(
                "Starting correlation tracking demo", correlation_id=ctx.correlation_id
            )
            ...
            logger.info(
                "Correlation tracking demo completed",
    ...
    async def simulate_service_call(correlation_id: str):
        ...
        with CorrelationContext(
            ...
            logger.info(
                "External service call initiated",
