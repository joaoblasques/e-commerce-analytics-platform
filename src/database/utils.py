...
def get_database_size() -> Dict[str, Any]:
    ...
    with get_database_session() as session:
        ...
        return {"database_size": db_size, "table_sizes": table_sizes}
...
def get_database_stats() -> Dict[str, Any]:
    ...
    with get_database_session() as session:
        ...
        stats = {
            ...
            "customer_stats": {
                "active_customers": session.query(Customer)
                .filter(Customer.account_status == "active")
                .count(),
            ...
            "product_stats": {
                ...
                .count(),
                "out_of_stock": session.query(Product)
            ...
            "order_stats": {
                ...
                .count(),
                "pending_orders": session.query(Order)
                .filter(Order.order_status.in_(["pending", "confirmed", "processing"]))
                .count(),
            },
        }
