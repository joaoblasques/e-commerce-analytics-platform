...
@fraud_rules.command()
@click.option("--input-path", required=True, help="Path to the input data (e.g., Delta table of transactions).")
@click.option("--output-path", required=True, help="Path to write the fraud detection results.")
@click.option("--rules-config", required=True, help="JSON string of rules or path to a JSON file with rules.")
