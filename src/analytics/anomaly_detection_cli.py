...
@anomaly.command()
@click.option("--stream-source-path", default="data/delta/transactions", help="Path to the streaming data source (e.g., Delta table).")
@click.option("--feature-cols", required=True, help="Comma-separated list of feature columns for anomaly detection.")
@click.option("--output-path", default=None, help="Optional path to write detected anomalies (e.g., Delta table).")
