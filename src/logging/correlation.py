...
class CorrelationContext:
    ...
    def __init__(
        ...
        self.previous_trace_context: Optional[TraceContext] = None
    ...
    def get_duration_ms(self) -> float:
        ...
        if self.trace_context.start_time is None:
            return 0.0
...
def extract_trace_from_headers(headers: Dict[str, str]) -> Optional[TraceContext]:
